...
test("work projects include gallery and detail section metadata", async () => {
  ...
  assert.ok(Array.isArray(first.galleryImages), "galleryImages should be an array");
  assert.ok(Array.isArray(first.detailSections), "detailSections should be an array");
});
